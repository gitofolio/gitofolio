 ...
 <svg width="${svgDTO.getViewBoxWidth()}" height="${svgDTO.getViewBoxHeight()}" viewBox="0 0 ${svgDTO.getViewBoxWidth()} ${svgDTO.getViewBoxHeight()}" fill="none" xmlns="http://www.w3.org/2000/svg"
	 ...
	 <style type="text/css">
		...
		.userName {
            ...
            font : 700 18px Arial, Noto Sans KR, Apple SD Gothic Neo, Apple SD 산돌고딕 Neo, Nanum Gothic, sans-serif;
        ...
        .portfolio {
            ...
            font : 100 12px Arial, Noto Sans KR, Apple SD Gothic Neo, Apple SD 산돌고딕 Neo, Nanum Gothic, sans-serif;
        ...
        .article {
			fill : ${svgDTO.getColor().getTextColor()};
            font : 400 13px Arial, Noto Sans KR, Apple SD Gothic Neo, Apple SD 산돌고딕 Neo, Nanum Gothic, sans-serif;
        ...
        .watchedText {
			fill : ${svgDTO.getColor().getTextColor()};
            font : 400 11px Arial, Noto Sans KR, Apple SD Gothic Neo, Apple SD 산돌고딕 Neo, Nanum Gothic, sans-serif;
			animation: delayFadeInAnimation 1.1s ease-in-out;
			text-shadow: ${svgDTO.getColor().getTextShadowColor()};
		}
