...
image::https://api.gitofolio.com/portfoliocard/svg/5?color=white[devxb's sample card]
...
image::https://api.gitofolio.com/portfoliocard/svg/5?color=black[devxb's sample card]
