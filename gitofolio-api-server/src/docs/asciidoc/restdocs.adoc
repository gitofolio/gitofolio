...
image::https://api.gitofolio.com/portfoliocard/svg/23?color=white[devxb's sample card]
...
image::https://api.gitofolio.com/portfoliocard/svg/23?color=black[devxb's sample card]
