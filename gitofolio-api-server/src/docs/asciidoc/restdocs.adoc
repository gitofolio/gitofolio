...
image::https://api.gitofolio.com/portfoliocard/svg/742?color=white[devxb's sample card]
...
image::https://api.gitofolio.com/portfoliocard/svg/742?color=black[devxb's sample card]
