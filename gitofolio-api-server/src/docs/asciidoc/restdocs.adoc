...
:doctype: book
:description: Gitofolio Rest ful api docs
:icons: font
...
NOTE: 우리의 공식 홈페이지 입니다. https://gitofolio.com[바로가기]
...
* [*] api server : 공유되는 ``**분당 100회의 요청량**``이 제공되며, 추가로 ``**언제든 사용가능한 50회의 요청량**``이 제공됩니다.
* [*] front server : 공유되는 ``**분당 100회의 요청량**``이 제공되며, 추가로 ``**언제든 사용가능한 10회의 요청량**``이 제공됩니다.
* [*] image server : 공유되는 ``**분당 10회의 요청량**``이 제공되며, 추가로 ``**언제든 사용가능한 10회의 요청량**``이 제공됩니다.

CAUTION: 모든 추가되는 요청량은 리셋되는 공유 요청량에서 차감됩니다.
